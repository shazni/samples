...
public final class Constants {
    ...
    public static final String DEPLOY_AS_A_PROTOTYPE = "Deploy as a Prototype";     // Older versions '"Deploy+as+a+Prototype"'
    public static final String DEMOTE_TO_CREATED = "Demote to Created";             // "Demote+to+Created"
    public static final String DEMOTE_TO_PROTOTYPED = "Demote to Prototyped";       // "Demote+to+Prototyped"
